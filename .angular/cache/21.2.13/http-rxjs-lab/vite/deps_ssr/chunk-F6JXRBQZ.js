...
import {
  ...
  Router,
  loadChildren
} from "./chunk-PFYFFDFJ.js";
import {
  BrowserDomAdapter,
  BrowserModule
} from "./chunk-NVDSLQF3.js";
import {
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin
} from "./chunk-C5RV73PM.js";
import {
  HTTP_ROOT_INTERCEPTOR_FNS
} from "./chunk-USSKVNRX.js";
import {
  APP_BASE_HREF,
  NullViewportScroller,
  PLATFORM_SERVER_ID,
  ViewportScroller
} from "./chunk-SWUKBC4P.js";
import {
  PlatformLocation,
  XhrFactory,
  getDOM,
  setRootDomAdapter
} from "./chunk-CT5YYVGR.js";
import {
  APP_ID,
  ApplicationRef,
  CSP_NONCE,
...
function parseUrl(urlStr, origin) {
  if (!urlStr) {
    return origin !== void 0 ? new URL("/", origin) : null;
  }
...
function _document() {
  ...
  if (config && config.document) {
    document2 = typeof config.document === "string" ? _enableDomEmulation ? parseDocument(config.document, config.url !== void 0 ? parseUrl(config.url, "http://localhost").href : void 0) : window.document : config.document;
  } else {
...
//# sourceMappingURL=chunk-F6JXRBQZ.js.map
